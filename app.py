...
------------------------------------------------
This application helps users compare their resume with job descriptions
to determine the match percentage and identify key relevant keywords.
"""
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        # Team members
        team_members = [
            {"name": "Rythm", "role": "Team Leader"},
            {"name": "Rishabh", "role": "Member"},
            {"name": "Ayush", "role": "Member"},
            {"name": "Ekansh", "role": "Member"}
        ]
